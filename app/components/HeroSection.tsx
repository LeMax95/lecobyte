        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl px-4 sm:px-0">
                Full-stack web developer focused on fast, accessible products with custom booking, payments, and technical SEO.
              </p>
            </div>

            {/* Tech Stack Pills */}
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
              {['React', 'TypeScript', 'Node.js', 'Tailwind', 'Prisma'].map((tech) => (
                <span
                  key={tech}
          ...
          <div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
            {[
              ...
              { name: 'LinkedIn', icon: '💼', href: 'https://www.linkedin.com/company/lecobyte-web-design-development-studio' },
